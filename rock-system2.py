...
PHOTOS_DIR = Path(__file__).parent / "rock2"
EXTENSIONS = {".png", ".jpg", ".jpeg", ".webp"}

# 白色背景画布 2160x3840，播放图 1872x2424 居中
CANVAS_WIDTH = 2160
CANVAS_HEIGHT = 3840
IMAGE_WIDTH = 1872
IMAGE_HEIGHT = 2424
IMAGE_X = (CANVAS_WIDTH - IMAGE_WIDTH) // 2   # 144
IMAGE_Y = (CANVAS_HEIGHT - IMAGE_HEIGHT) // 2  # 708

WINDOW_NAME = "Rock2 Player"
