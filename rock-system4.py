...
PHOTOS_DIR = Path(__file__).parent / "rock4"
EXTENSIONS = {".png", ".jpg", ".jpeg", ".webp"}

# 白色背景画布 3840x2160（横版），播放图 2504x1872 居中
CANVAS_WIDTH = 3840
CANVAS_HEIGHT = 2160
IMAGE_WIDTH = 2504
IMAGE_HEIGHT = 1872
IMAGE_X = (CANVAS_WIDTH - IMAGE_WIDTH) // 2   # 668
IMAGE_Y = (CANVAS_HEIGHT - IMAGE_HEIGHT) // 2  # 144

WINDOW_NAME = "Rock4 Player"
WINDOW_WIDTH = 1152  # 3840 * 0.3
WINDOW_HEIGHT = 648  # 2160 * 0.3
POLL = 0.05
QUIT_KEYS = (ord("q"), 27)
