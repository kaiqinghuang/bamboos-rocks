...
PHOTOS_DIR = Path(__file__).parent / "rock3"
EXTENSIONS = {".png", ".jpg", ".jpeg", ".webp"}

# 白色背景画布 2160x3840，播放图 1872x2736 居中
CANVAS_WIDTH = 2160
CANVAS_HEIGHT = 3840
IMAGE_WIDTH = 1872
IMAGE_HEIGHT = 2736
IMAGE_X = (CANVAS_WIDTH - IMAGE_WIDTH) // 2   # 144
IMAGE_Y = (CANVAS_HEIGHT - IMAGE_HEIGHT) // 2  # 552

WINDOW_NAME = "Rock3 Player"
